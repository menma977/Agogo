package id.co.agogo.view.bot.fibonacci
...
class BotChartAndProgressBarGoneActivity : AppCompatActivity() {
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    setContentView(R.layout.activity_bot_chart_and_progress_bar_gone)
    ...
    synchronized(trigger) {
      while (balanceRemaining in balanceLimitTargetLow..balanceTarget) {
        ...
        if (delta >= 1000) {
          ...
          formula = fibonacciArray[fibonacciJump]
          ...
          if (response["code"] == 200) {
            ...
            payIn = bitCoinFormat.dogeToDecimal(bitCoinFormat.decimalToDoge(balanceRemaining) * BigDecimal(0.001))
